 ...
 *
 * @param {Object} payload - { action, fullName, company, phone, email, privacyAccepted, aupAccepted }
 * @returns {TextOutput} JSON response
 */
...
function getSheet(sheetName) {
  ...
  if (!sheet) {
    ...
    if (sheetName === OTP_SHEET_NAME) {
      ...
      sheet.appendRow(['Timestamp', 'Full Name', 'Company', 'Phone', 'Email', 'Privacy Accepted', 'AUP Accepted']);
